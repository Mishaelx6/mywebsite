...
import javsScriptImage from './assets/js.png';

function JavaScriptProficiency() {
  ...
  return (
    <div className="js-proficiency-section">
      <img src={javsScriptImage} alt="JavaScript" className="js-image" />
...
export default JavaScriptProficiency;
